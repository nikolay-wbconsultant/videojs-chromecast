/*! @silvermine/videojs-chromecast 2021-05-27 v1.1.2-2-g6607ac2-dirty */
    ...
    10: [ function(require, module, exports) {
        ...
        ChromecastTech = {
            ...
            _onChangeTrack: function(source) {
                var castSession = cast.framework.CastContext.getInstance().getCurrentSession(), customData = this._requestCustomData(source), activeTrackIds = [], media, subtitles, tracksInfoRequest;
                if (castSession) {
