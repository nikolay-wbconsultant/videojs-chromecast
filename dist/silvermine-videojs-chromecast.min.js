/*! @silvermine/videojs-chromecast 2021-07-14 v1.1.2-3-g6f06705-dirty */
    ...
    10: [ function(require, module, exports) {
        ...
        ChromecastTech = {
            ...
            _onChangeTrack: function(source) {
                var castSession = cast.framework.CastContext.getInstance().getCurrentSession(), customData = this._requestCustomData(source), activeTrackIds = [], media, subtitles, subTitleTracks, tracksInfoRequest;
                if (castSession) {
                    subtitles = this.videojsPlayer.remoteTextTracks();
                    subTitleTracks = _.filter(subtitles.tracks_, function(t) {
                        return !t.src;
                    });
            ...
            _playSource: function(source, startTime) {
                var castSession = this._getCastSession(), tracks = this.getTextTracks(source), mediaInfo = new chrome.cast.media.MediaInfo(source.src, source.type), title = this._requestTitle(source), subtitle = this._requestSubtitle(source), customData = this._requestCustomData(source), trackStyle = new chrome.cast.media.TextTrackStyle(), request;
            ...
            getTextTracks: function(source) {
                var tracks = [], customData = this._requestCustomData(source);
